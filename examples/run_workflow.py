...
from jobflowchemistry.ConformerGeneration import rdKitConformers, Auto3DConformers
...
aimnet2energy_job = aimnet2energy_maker.make(structure=rdKitConf_job.output['structure'])
aimnet2opt1_job = aimnet2opt_maker.make(structure=aimnet2energy_job.output["structure"])
auto3d_job = auto3d_maker.make(aimnet2opt1_job.output["structure"])
aimnet2energy2_job = aimnet2energy_maker.make(structure=auto3d_job.output["structure"])
